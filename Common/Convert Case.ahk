 ...
 *    - Tooltip says what new case is
 *    - A timer resets the cycle back to lowercase after 30 seconds
 *    - This code does NOT like multi-line selections
 * 
 *  Technical Notes
 ...
 *    slower when used here. I do not know why, nor did I have the time to figure out why and fix it.
 *  - Instead of using SendInput to send the converted text, it is MUCH faster to load that text into the clipboard
 *    and SendInput("^v")
 */
ConvertCase() {
