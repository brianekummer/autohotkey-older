...
;  return
;}
; If don't want the above, then disable CapsLock using the below code
CapsLock:: return
...
/*
  It seems that these are the actions that mess up my CapLock key.
  I cannot figure out how to PREVENT it, so instead I'll try to 
  fix it immediately AFTER it happens by calling FixBrokenCapsLock().
*/
...
/*
   I have problems with CapsLock sometimes getting stuck, and this code
